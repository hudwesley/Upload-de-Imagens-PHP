<?php 
    ...
    if(isset($_POST["upload"])){
        ...
        //definir qual pasta a imagems será salva
        $folder = "uploads";
        ...
        //mensagens de erro
        $msg = array(); //cria uma array vazio 
        $erroMsg = array(
            1 => "O arquivo é maior que o limite permitido", 
            2 => "O upload do arquivo foi feito com parcialmente",
        ...
        for($i = 0; $i < $numFile; $i++){
            ...
            $erro = $file["error"][$i]; // pega os erros
            $tmp = $file["tmp_name"][$i]; // pega um nome temporario para o arquivo
            ...
            }else{ // se não ocorreu algum erro, vamos inserir o arquivo
